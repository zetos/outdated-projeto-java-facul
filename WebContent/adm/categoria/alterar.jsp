					...
					<form action="/ProjetoFinal/CategoriaAlterar" method="post">
						<div class="row form-group">
							<label for="nome">Nome</label> <input class="form-control"
								type="text" name="nome" value="${categoria.nome}"
								id="name_categoria">
						</div>
						<div class="row form-group">
							<label for="categoriaId">Categoria Id</label> <input
								class="form-control" type="text" name="categoriaId"
								value="${categoria.categoriaId}" id="id_categoria"
								readonly="readonly">
						</div>
						<div class="row form-group">
							<label for="faixaEtaria">Faixa Etaria</label> <select
								class="form-control" id="faixa" name="faixaEtaria">
						...
						<div class="row form-group">
							<label for="linha">Linha</label> <select class="form-control"
								id="linha" name="linha">
								<option value="Todos">Todos</option>
						...
						<div class="row form-group text-right">
							<input type="submit" class="btn btn-primary btn-lg"
								name="bSalvar" value="Salvar" /> <a
								class="btn btn-default btn-lg"
								href="/ProjetoFinal/CategoriaListar" role="button">Voltar</a>
						</div>
					</form>
				</div>
			</div>
