    					...
    					<div class="row">
    						<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1">
    							...
    							<div class="row control-group">
    								<div class="form-group col-xs-12 controls">
    									...
    									<div class="input-group">
    										...
    										<input type="text" class="form-control" id="brinquedo_preco" name="preco" placeholder="Preço do brinquedo.." required data-validation-required-message="Por favor insira o valor do brinquedo..">
    									</div>
    								</div>
    							</div>
    							...
    							<div class="form-group col-xs-12 floating-label-form-group controls">
    								...
    								class="form-control" placeholder="Caminho da Imagem do Brinquedo"
    								name="nome" id="name_brinquedo" required
