							...
							<table class="table table-striped">
								<tr>
									...
									<td><input class="form-control" type="text" name="id"
										value="${produto.produtoId}" id="id_categoria" readonly="readonly"></td>
									</tr>
									<tr>
										...
										<tr>
											<td>Descrição:</td>
											<td><textarea class="form-control" rows="2" id="brinquedo_descricao" name="descricao" placeholder="Insira a descrição do brinquedo.." required data-validation-required-message="Por favor insira a descrição do brinquedo" value="${produto.descricao}"></textarea></td>
										</tr>
										<tr>
											<td>Preço:</td>
											<td><div class="input-group">
												<div class="input-group-addon">R$</div>
												<input type="text" class="form-control" id="brinquedo_preco" name="preco" placeholder="Preço do brinquedo.." required data-validation-required-message="Por favor insira o valor do brinquedo.." value="${produto.preco}">
											</div></td>
										</tr>
										<tr>
											<td>Imagem do brinquedo:</td>
											<td><input class="form-control" type="text" name="imagem"
												value="${produto.img}" id="name_categoria" required></td>
											</tr>
											<tr>
												<td>Categoria:</td>
												<td><select class="form-control" id="brinquedo_categoria" name="categoria">
										...
										<tr>
											<th colspan="2"><input type="submit"
												...
												value="Salvar" /> <a
												class="btn btn-default btn-lg editar-img" href="/ProjetoFinal/ProdutosListar"
